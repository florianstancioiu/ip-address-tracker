...
class S {
  ...
  u(t) {
    ...
    for (; void 0 !== l;) {
      if (o === l.index) {
        let i;
        2 === l.type ? i = new M(h, h.nextSibling, this, t) : 1 === l.type ? i = new l.ctor(h, l.name, l.strings, this, t) : 6 === l.type && (i = new L$1(h, this, t)), this._$AV.push(i), l = s[++n];
      }
...
.wrapper {
  ...
  background-image: url('../src/assets/header-bg.png'), linear-gradient(225deg, var(--clr-2) 2.99%, var(--clr-3) 100%);
...
const Map$1 = (element) => {
    ...
    useEffect(() => {
        ...
        // @ts-ignore
        const map = L.map(mapDiv).setView([locationData.location.lat, locationData.location.lng], 13);
        // @ts-ignore
